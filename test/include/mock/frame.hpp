...
public :
    ...
    // Mocks for frame
    MOCK_CONST_METHOD0(north_border_height, terminalpp::coordinate_type ());
    MOCK_CONST_METHOD0(south_border_height, terminalpp::coordinate_type ());
